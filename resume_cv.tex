...
\definecolor{awesome}{HTML}{FE5A1D}
...
% \definecolor{lighttext}{HTML}{FFA607}
...
\email{george.marcu20@gmail.com}
% \homepage{www.posquit0.com}
\github{marcGames1}
% \linkedin{alexandru-marweb}
%\skype{skypeid}
...
\position{Head of SEO{\enskip\cdotp\enskip}Technical \& Growth}
\makecvfooter{\today}{Alexandru Marcu Senior SEO Expert~~~·~~~Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
